<%@ Page Title="" Language="C#" MasterPageFile="~/NavegadorPrincipal.Master" AutoEventWireup="true" CodeBehind="catAPsubprograma.aspx.cs" Inherits="SIP.Formas.Catalogos.catAPsubrprograma" %>
        ...
        <asp:GridView Height="25px" ShowHeaderWhenEmpty="true" CssClass="table" ID="grid" DataKeyNames="Id" AutoGenerateColumns="False" runat="server">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Nombre" ItemStyle-CssClass="col-md-10">
                        ...
                        <ItemTemplate>
                            <asp:ImageButton ID="imgTipoSubPrograma" ToolTip="Tipo de subprogramas" runat="server" ImageUrl="~/img/Sub.png" OnClick="imgTipoSubPrograma_Click"/>
