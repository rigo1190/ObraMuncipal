<%@ Page Title="" Language="C#" MasterPageFile="~/NavegadorPrincipal.Master" AutoEventWireup="true" CodeBehind="catModalidadAdjudicacion.aspx.cs" Inherits="SIP.Formas.Catalogos.catModalidadAdjudicacion" %>
   ...
   <div class="container">
    ...
    <div id="divDatos" runat="server" class="panel panel-success">
        <div class="panel-heading">
            <h3 class="panel-title">Modalidad de Adjudicación</h3>
        </div>
