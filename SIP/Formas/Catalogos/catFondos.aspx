<%@ Page Title="" Language="C#" MasterPageFile="~/NavegadorPrincipal.Master" AutoEventWireup="true" CodeBehind="catFondos.aspx.cs" Inherits="SIP.Formas.Catalogos.catFondos" %>
   ...
   <div class="container">
    ...
    <div id="divDatos" runat="server" class="panel panel-success">
        <div class="panel-heading">
            <h3 class="panel-title">Fondos</h3>
        </div>
       ...
       <div id="divCaptura" runat="server" class="panel panel-success">
        ...
        <div class="panel-heading">
            <h3 class="panel-title">Fondos :: Registre en los campos los datos solicitados</h3>
        </div>
