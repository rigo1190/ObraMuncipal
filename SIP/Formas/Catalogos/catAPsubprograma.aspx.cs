...
{
    public partial class catAPsubrprograma : System.Web.UI.Page
    {
        ...
        private void BindGrid()
        {
            ...
            this.grid.DataSource = uow.AperturaProgramaticaBusinessLogic.Get(p => p.EjercicioId == ejercicio && p.ParentId == idPrograma  && p.Nivel == 2);
            this.grid.DataBind();

            AperturaProgramatica ap = uow.AperturaProgramaticaBusinessLogic.GetByID(idPrograma);
            this.txtTitulo.Text = ap.Clave + " - " + ap.Nombre + " >> Subprogramas...";
            this.txtTituloBis.Text = ap.Clave + " - " + ap.Nombre + " >> Subprogramas..."; 
        ...
        protected void imgTipoSubPrograma_Click(object sender, ImageClickEventArgs e)
        {
            int id;
            GridViewRow row = (GridViewRow)((ImageButton)sender).NamingContainer;
            ...
            Response.Redirect("catAPTipoSubprograma.aspx?id=" + id);
        }
