...
namespace SIP.Formas.Catalogos
{
    ...
    {      
        ...
        public static IQueryable GetList()
        {
            ...
            var list = uow.MunicipioBusinessLogic.Get().Select(e => new { Id=e.Id,Clave=e.Clave,Nombre=e.Nombre});
            return list;
        }
        ...
        public static object GetRecord(int id)
        {
            ...
            return new {Id=municipio.Id,Clave=municipio.Clave,Nombre=municipio.Nombre };
        ...
        public static object AddRecord(string clave, string nombre, int orden)
        {
            ...
            Municipio municipio = new Municipio { Clave = clave, Nombre = nombre};  
