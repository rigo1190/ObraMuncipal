<%@ Page Title="" Language="C#" MasterPageFile="~/NavegadorPrincipal.Master" AutoEventWireup="true" CodeBehind="catLocalidades.aspx.cs" Inherits="SIP.Formas.Catalogos.catLocalidades" %>
 ...
 <div class="container">
    ...
    <div id="divDatos" runat="server" class="panel panel-success">
       ...
       <div id="divCaptura" runat="server" class="panel panel-success">
        ...
        <div class="panel-heading">
            <h3 class="panel-title">Localidades :: Registre en los campos los datos solicitados</h3>
        </div>
