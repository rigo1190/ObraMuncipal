<%@ Page Title="" Language="C#" MasterPageFile="~/NavegadorPrincipal.Master" AutoEventWireup="true" CodeBehind="catConceptosDeObraGrupoAdd.aspx.cs" Inherits="SIP.Formas.Catalogos.catConceptosDeObraGrupoAdd" %>
...
<div id="contenedor" runat="server" class="container">
            ...
            <div id="divDatos" >
                <div class="panel panel-success">
                    <div class="panel-heading">
                        ...
                        <div class="row">
                            <div class="col-md-8"><h3 class="panel-title">Agrupadores de Conceptos de Obra</h3></div>
                        ...
                        <asp:TreeView runat="server" SelectedNodeStyle-ForeColor="Black" AutoPostBack="false" ID="treeMain"  ShowLines="True"  NodeIndent="25"  AutoGenerateDataBindings="False" Width="117px" OnSelectedNodeChanged="treeMain_SelectedNodeChanged">
                         ...
                         <div id="custom-menu">
                                <ol>
                                    ...
                                    <li>
                                        <asp:Button ID="addsp" Width="160px" AutoPostBack="false" CssClass="btn btn-default evento" OnClientClick="return false"  runat="server" Text="Agregar Subgrupo" /> 
                                    </li>
        ...
        <div class="row">
            <div id="divcaptura" runat="server" class="panel panel-success">
                    ...
                    <span runat="server" id="SpanFondo" class="label label-primary">Agregando Subgrupo ...</span>
