...
{
    public partial class catDependenciasNormativas : System.Web.UI.Page
    {
        ...
        private void BindGrid()
        {
            ...
            this.grid.DataSource = uow.DependenciaNormativaBL.Get().ToList();
            this.grid.DataBind();
        }
        ...
        protected void imgBtnEdit_Click(object sender, ImageClickEventArgs e)
        {
            ...
            DependenciaNormativa obj = uow.DependenciaNormativaBL.GetByID(int.Parse(_ElId.Text));
        ...
        protected void imgBtnEliminar_Click(object sender, ImageClickEventArgs e)
        {
            ...
            uow.Errors.Clear();
            //List<Obra> lista;
            //lista = uow.ObraBusinessLogic.Get(p => p.depe == obj.Id).ToList();
            ...
            {
                uow.DependenciaNormativaBL.Delete(obj);
                uow.SaveChanges();
                BindGrid();
            }
        ...
        {
            DependenciaNormativa obj;

            List<DependenciaNormativa> lista;

            String mensaje = "";


            if (_Accion.Text == "Nuevo")
                obj = new DependenciaNormativa();
            else
                obj = uow.DependenciaNormativaBL.GetByID(int.Parse(_ElId.Text));
            ...
            { //update
                ...
                lista = uow.DependenciaNormativaBL.Get(p => p.Clave == obj.Clave && p.Id != xid).ToList();
                if (lista.Count > 0)
                    uow.Errors.Add("La Clave que capturo ya ha sido registrada anteriormente, verifique su información");



                lista = uow.DependenciaNormativaBL.Get(p => p.Nombre == obj.Nombre && p.Id != xid).ToList();
                if (lista.Count > 0)
                    uow.Errors.Add("La Descripción que capturo ya ha sido registrada anteriormente, verifique su información");


                uow.DependenciaNormativaBL.Update(obj);
