<%@ Page Title="" Language="C#" MasterPageFile="~/NavegadorPrincipal.Master" AutoEventWireup="true" CodeBehind="catAPprograma.aspx.cs" Inherits="SIP.Formas.Catalogos.catAPprograma" %>
   ...
   <div class="container">
    ...
    <div id="divDatos" runat="server" class="panel panel-success">
        ...
        <asp:GridView Height="25px" ShowHeaderWhenEmpty="true" CssClass="table" ID="grid" DataKeyNames="Id" AutoGenerateColumns="False" runat="server">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Nombre" ItemStyle-CssClass="col-md-10">
                        ...
                        <ItemTemplate>
                            <asp:ImageButton ID="imgSubProgramas" ToolTip="Subprogramas" runat="server" ImageUrl="~/img/Sub.png" OnClick="imgSubProgramas_Click"/>
       ...
       <div id="divCaptura" runat="server" class="panel panel-success">
        ...
        <div class="panel-heading">
            <h3 class="panel-title">Programas :: Registre en los campos los datos solicitados</h3>
        </div>
