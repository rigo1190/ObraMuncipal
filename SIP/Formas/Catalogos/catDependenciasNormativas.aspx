<%@ Page Title="" Language="C#" MasterPageFile="~/NavegadorPrincipal.Master" AutoEventWireup="true" CodeBehind="catDependenciasNormativas.aspx.cs" Inherits="SIP.Formas.Catalogos.catDependenciasNormativas" %>
   ...
   <div class="container">
    ...
    <div id="divDatos" runat="server" class="panel panel-success">
        <div class="panel-heading">
            <h3 class="panel-title">Dependencias Normativas</h3>
        </div>
       ...
       <div id="divCaptura" runat="server" class="panel panel-success">
        ...
        <div class="panel-heading">
            <h3 class="panel-title">Dependencias Normativas :: Registre en los campos los datos solicitados</h3>
        </div>
